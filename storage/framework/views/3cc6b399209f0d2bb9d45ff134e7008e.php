...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('settings.personal.users.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="user_type" id="user_type" 
                                class="form-select <?php $__errorArgs = ['user_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php if(old('user_type') == $value): echo 'selected'; endif; ?>>
                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($region->id); ?>" <?php if(old('region_id') == $region->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $sectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sector->id); ?>" <?php if(old('sector_id') == $sector->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($school->id); ?>" <?php if(old('school_id') == $school->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="<?php echo e(route('settings.personal.users.index')); ?>" class="btn btn-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/home/Library/CloudStorage/OneDrive-BureauonICTforEducation,MinistryofEducation/infoline_app/resources/views/pages/settings/personal/users/create.blade.php ENDPATH**/ ?>