    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="sectorAdminForm" method="POST" class="needs-validation" novalidate>
                ...
                <input type="hidden" name="sector_id" value="<?php echo e($sector->id); ?>">
...
<?php /**PATH /Users/home/Library/CloudStorage/OneDrive-BureauonICTforEducation,MinistryofEducation/infoline_app/resources/views/pages/settings/personal/modals/sector-admin-modal.blade.php ENDPATH**/ ?>