<div class="btn-group">
    ...
    <div class="btn-group">
        <button type="button" class="btn btn-sm btn-info assign-admin" data-id="<?php echo e($school->id); ?>" data-bs-toggle="modal" data-bs-target="#assignAdminModal" title="Mövcud istifadəçini admin təyin et">
            <i class="fas fa-user-shield"></i>
        </button>
        <a href="<?php echo e(route('settings.personal.schools.admin.create', $school)); ?>" class="btn btn-sm btn-success" title="Yeni admin yarat">
