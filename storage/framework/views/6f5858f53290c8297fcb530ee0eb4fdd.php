...
<div class="modal fade" id="addColumnModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="columnForm" action="<?php echo e(route('settings.table.column.store')); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
...
document.getElementById('addColumnModal').addEventListener('hidden.bs.modal', function () {
    const form = document.getElementById('columnForm');
    form.reset();
    form.action = "<?php echo e(route('settings.table.column.store')); ?>";
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/home/Library/CloudStorage/OneDrive-BureauonICTforEducation,MinistryofEducation/infoline_app/resources/views/partials/column-modal.blade.php ENDPATH**/ ?>