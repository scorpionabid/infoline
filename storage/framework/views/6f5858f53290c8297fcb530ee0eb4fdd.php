    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addColumnForm" method="POST" action="/settings/table/column" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="category_id" value="<?php echo e(request()->query('category')); ?>">
...
</script><?php /**PATH /Users/home/Library/CloudStorage/OneDrive-BureauonICTforEducation,MinistryofEducation/infoline_app/resources/views/partials/column-modal.blade.php ENDPATH**/ ?>