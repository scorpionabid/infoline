...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="categoryForm" action="<?php echo e(route('settings.table.category.store')); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
...
function editCategory(id) {
    fetch(`/api/v1/categories/${id}`)
        ...
        .then(data => {
            ...
            form.insertAdjacentHTML('beforeend', `<?php echo method_field('PUT'); ?>`);
...
document.getElementById('addCategoryModal').addEventListener('hidden.bs.modal', function () {
    const form = document.getElementById('categoryForm');
    form.reset();
    form.action = "<?php echo e(route('settings.table.category.store')); ?>";
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/home/Library/CloudStorage/OneDrive-BureauonICTforEducation,MinistryofEducation/infoline_app/resources/views/partials/category-modal.blade.php ENDPATH**/ ?>